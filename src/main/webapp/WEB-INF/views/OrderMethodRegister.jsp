...
<form:form action="omsave" method="post" modelAttribute="orderMethod">
...
<div class="col-6">
   ...
   <p style="color: red;" ><form:errors path="orderMode" cssClass="error"></form:errors></p>
</div>      
...
<p style="color: red;"><form:errors path="orderCode" cssClass="error"></form:errors>              </p>
</div>
...
<div class="col-6">
              ...
              <form:checkbox path="orderAccept" value="mutltimode"/>multi-mode
              ...
              <form:checkbox path="orderAccept" value="service extend"/>service extend
               ...
               <p style="color: red;"><form:errors path="orderAccept" cssClass="error" /></p>
</div>
   ...
   <p style="color: red;"><form:errors path="orderDesc" cssClass="error" /></p>
   </div>         
   ...
   <input class="btn btn-success" type="submit" value="create ordermethod">
