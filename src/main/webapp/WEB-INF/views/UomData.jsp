...
<td>   <c:out value="${um.dsc}"></c:out>     </td> --%>
									<td><a href="udelete?uid=${um.uomId}"><img
											alt="delete" src="../resources/images/delete.png" width="20"
											height="20" /></a></td>

									<td><a href="viewall?uid=${um.uomId}"><img
											alt="viewall" src="../resources/images/view.png" width="20"
											height="20"> </a>
									<td><a href="ueditone?uid=${um.uomId}"><img alt="edit"
											src="../resources/images/edit.png" width="20" height="20"></a></td>

									<td><a href="export?uid=${um.uomId}"><img alt="excel"
											src="../resources/images/excel.png" width="20" height="20"></a></td>
